import { j as o, a as l, I as k, g as p } from "./index.ab871105.mjs";
...
const M = ({
  ...
  let t = /* @__PURE__ */ o("span", {
    className: "cnn",
    children: s
  }), n = "connect-wallet-button";
  return L && (t = /* @__PURE__ */ o("span", {
    className: "acc",
    children: L.toMasskedAddress()
  }), n = `${n} active`), /* @__PURE__ */ l("div", {
    onClick: L ? void 0 : r,
    className: n,
...
const E = ({
  ...
  let n = e ? "chain-btn-active" : "chain-btn";
  const c = i && !e;
  let d;
  return c ? d = () => a() : (n = `${n} can-not-switch`, d = () => {
  }), /* @__PURE__ */ o(u, {
    block: !0,
    className: n,
    disabled: r,
