...
export declare const CollectionFilterMobile: ({ filterStore, searchable, searchPlaceholder, addFilterEventListeners, removeFilterEventListeners, onChange }: ICollectionFilterMobileProps) => JSX.Element;
