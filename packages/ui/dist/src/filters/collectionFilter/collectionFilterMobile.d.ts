...
export declare const CollectionFilterMobile: ({ filterStore, searchable, searchPlaceholder, circleIcons, addFilterEventListeners, removeFilterEventListeners, onChange, noClear }: ICollectionFilterMobileProps) => JSX.Element;
