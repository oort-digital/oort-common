import { j as ut, a as Fn, I as Rn, g as wi } from "./index.7539c891.mjs";
...
function mo(e) {
  var t, r = Jn(e), n = r[0], f = r[1], i = new co(go(e, n, f)), p = 0, h = f > 0 ? n - 4 : n, g;
  for (g = 0; g < h; g += 4)
...
(function(e) {
  var t = ne, r = ko, n = Ro, f = No, i = Po, p = $t, h = Ot, g = ri.exports;
  function x(S) {
...
function Qo(e, t, r) {
  for (var n = Ge.getSymbolTotalCodewords(t), f = Ar.getTotalCodewordsCount(t, r), i = n - f, p = Ar.getBlocksCount(t, r), h = n % p, g = p - h, x = Math.floor(n / p), _ = Math.floor(i / p), R = _ + 1, I = x - _, U = new $o(I), N = 0, W = new Array(p), A = new Array(p), S = 0, k = on.from(e.buffer), B = 0; B < p; B++) {
    var q = B < g ? _ : R;
...
ii.render = function(t, r, n) {
  var f = ea.getOptions(r), i = t.modules.size, p = t.modules.data, h = i + f.margin * 2, g = f.color.light.a ? "<path " + an(f.color.light, "fill") + ' d="M0 0h' + h + "v" + h + 'H0z"/>' : "", x = "<path " + an(f.color.dark, "stroke") + ' d="' + ra(p, i, f.margin) + '"/>', _ = 'viewBox="0 0 ' + h + " " + h + '"', R = f.width ? 'width="' + f.width + '" height="' + f.width + '" ' : "", I = '<svg xmlns="http://www.w3.org/2000/svg" ' + R + _ + ' shape-rendering="crispEdges">' + g + x + `</svg>
`;
...
function pa() {
  for (var e; Wr = Be.length; )
    e = Be.sort(function(t, r) {
      ...
      var r, n, f, i, p, h, g;
      t.__d && (h = (p = (r = t).__v).__e, (g = r.__P) && (n = [], (f = de({}, p)).__v = f, i = ci(g, p, f, r.__n, g.ownerSVGElement !== void 0, null, n, h == null ? Fe(p) : h), va(n, p), i != h && hi(p)));
    });
}
...
function ga(e, t, r, n, f, i, p, h) {
  ...
  if (t.type === null)
    ...
    da(e, N, U, f, h), R ? t.__k = [] : (t.__k = t.props.children, li(e, t, r, n, t.type !== "foreignObject" && f, i, p, Se, h)), h || ("value" in N && (g = N.value) !== void 0 && g !== e.value && Ze(e, "value", g, U.value, !1), "checked" in N && (g = N.checked) !== void 0 && g !== e.checked && Ze(e, "checked", g, U.checked, !1));
  }
  return e;
}
function pi(e, t, r) {
...
//# sourceMappingURL=index.es.74457be4.mjs.map
