...
import { a as e, j as c, O as v, F as A, b as a, T as q, c as L, D as y, u as E, M as F, d as g, i as D, g as x, B as R, C as H, e as u, t as S, f as W, N as O } from "./index.221adb39.mjs";
import { Switch as j, Button as b } from "antd";
import { observer as M } from "mobx-react";
const G = "_aside_desktop_izek7_1", K = "_logo_izek7_15", N = {
  aside_desktop: G,
  logo: K
}, U = "_root_udfzq_1", Y = "_icon_before_udfzq_1", J = "_icon_after_udfzq_7", P = "_account_img_udfzq_12", Q = "_social_udfzq_20", X = "_icon_udfzq_1", e1 = "_theme_switch_udfzq_29", t1 = "_theme_name_udfzq_32", o1 = "_menu_item_btn_udfzq_41", n1 = "_chain_name_udfzq_44", t = {
  root: U,
  icon_before: Y,
  icon_after: J,
  account_img: P,
...
}), a1 = "https://twitter.com/OortDigital", r1 = "https://t.co/6eYdGdfUK7?amp=1", l1 = "https://t.me/oortdigital", _1 = /* @__PURE__ */ c(a, {
  ...
  const [i, s] = k(!1), [r, p] = k(!1), [d, Z] = E(), I = () => /* @__PURE__ */ e(W, {
    onCancel: () => s(!1),
    visible: i,
    web3: n
  }), T = () => {
    ...
    return /* @__PURE__ */ c(a, {
      children: [I(), /* @__PURE__ */ e(u, {
        className: `${t.menu_item_btn} ${t.chain_name}`,
        onClick: () => s(!0),
        iconBefore: z,
        iconAfter: V,
        caption: h
    ...
    if ((C == null ? void 0 : C.isEnabled) === !0) {
      const l = /* @__PURE__ */ e("span", {
        className: t.icon_after,
        children: /* @__PURE__ */ e(H, {})
      }), {
        isLoading: _,
...
}, m1 = M(d1), h1 = "_aside_titb4_1", u1 = "_nav_menu_titb4_1", f1 = "_footer_titb4_4", f = {
  aside: h1,
  nav_menu: u1,
  footer: f1
}, M1 = ({
...
}), p1 = M(M1), V1 = "_logo_link_yaxcy_1", k1 = {
  logo_link: V1
}, g1 = () => /* @__PURE__ */ c("svg", {
  width: "100%",
  height: "100%",
  ...
  className: N.aside_desktop,
  navItems: o,
  web3: n,
  testNfts: i,
  isActiveFunc: C,
  logoLink: /* @__PURE__ */ e(H1, {
    className: N.logo
  })
}), w1 = M(b1), N1 = "_aside_mobile_q4nfg_1", z1 = {
  aside_mobile: N1
};
export {
  w1 as A,
...
//# sourceMappingURL=asideMobile.module.d7e93062.mjs.map
